...
set shortmess=aoO
badd +21 ~/picode/fiat-lux/pwm-driver/Servo_Example.py
badd +67 ~/picode/fiat-lux/pwm-driver/Adafruit_PWM_Servo_Driver.py
badd +50 ~/picode/fiat-lux/pwm-driver/Adafruit_I2C.py
badd +51 ~/.vimrc
args Servo_Example.py Adafruit_PWM_Servo_Driver.py
edit ~/picode/fiat-lux/pwm-driver/Servo_Example.py
...
wincmd w
argglobal
edit ~/picode/fiat-lux/pwm-driver/Adafruit_PWM_Servo_Driver.py
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <C-Space> =RopeCodeAssistInsertMode()
inoremap <buffer> <silent> <Nul> =RopeCodeAssistInsertMode()
